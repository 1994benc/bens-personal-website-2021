...
const initialData = {
  nodes: [
    ...
    {
      id: "beSciAndDataSci",
      label: "MSc. Behavioural and Data Science\n (Graduated with Distinction)",
    },
    { id: "contact", label: "Contact" },
    { id: "email", label: "benchomsang@protonmail.com", isCopyEnabled: true },
  ...
  edges: [
    ...
    {
      id: "softwareEngineering-frontEndWeb",
      source: "softwareEngineering",
      target: "frontEndWeb",
      label: "Specialised in",
    },
    {
      id: "softwareEngineering-backEndWeb",
      source: "softwareEngineering",
      target: "backEndWeb",
      label: "Specialised in",
    },
    {
      id: "frontEndWeb-typescript",
      source: "frontEndWeb",
      target: "typescript",
      label: "Using",
    },
    ...
    {
      id: "naturalLang-classification",
      source: "naturalLang",
      target: "classification",
      label: "Specifically",
    },
    {
      id: "naturalLang-topicModelling",
      source: "naturalLang",
      target: "topicModelling",
      label: "Specifically",
    },
    {
      id: "classification-python",
      source: "classification",
      target: "python",
      label: "Using",
    },
    {
      id: "topicModelling-python",
      source: "topicModelling",
      target: "python",
      label: "Using",
    },
    {
      id: "naturalLang-featureEngineering",
      source: "naturalLang",
